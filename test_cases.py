...
def test_valid_email():
    ...
    assert validate_email("sanjaygamil.com") is False, "Should be invalid due to missing @ symbol"
...
def test_valid_mobile_number():
    ...
    assert validate_mobile_number("9919819801") is False, "Should be invalid due to missing country code"
    assert validate_mobile_number("91 99345688O1") is False, "Should be invalid due to non-numeric characters"
...
def test_validate_user_password():
    ...
    assert check_password("23") is False, "Should be invalid due to length"
